<section className="flex flex-col justify-center item-center text-center">
  ...
  <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-2 xl:grid-cols-2 xl:gap-x-8">
    ...
    <div className="">
      <div className="shadow-lg rounded-lg relative overflow-hidden bg-no-repeat bg-cover">
        <img
          src="https://i.ytimg.com/vi/mv9afG2Dm9I/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLBuJe6KNUpfXqLkjFhV1MXptflw_g"
          alt="asdd"
        />
      </div>
    ...
    <div className="">
      <div className="shadow-lg rounded-lg relative overflow-hidden bg-no-repeat bg-cover">
        <img src="/static/project_bg.svg" alt="asdd" />
      </div>
      <h5 className="text-lg font-bold mb-3">E - Commerce WebPage</h5>
      <h6 className="mb-3 text-blue-600 font-medium text-sm flex items-center justify-center lg:justify-start">
        #HTML #CSS #JS
