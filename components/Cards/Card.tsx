  ...
  return (
    <>
      ...
      <div className="xl:min-w-[400px] xl:min-h-[600px] c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
        <div className="relative pb-48 overflow-hidden xl:pb-56">
          {/* eslint-disable-next-line jsx-a11y/alt-text */}
          <img
            className="min-h-[300px] absolute inset-0 h-full w-full object-cover"
            src={
              imageSrc ||
              "https://images.unsplash.com/photo-1601119479271-21ca92049c81?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=871&q=80"
            }
