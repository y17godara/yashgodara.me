            ...
            <div className="xl:min-w-[400px] h-full c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                ...
                <div className="p-4 flex flex-col sm:flex-row">
                    <div className="flex flex-col sm:w-1/2">
                        <span className="inline-block px-2 w-fit py-1 leading-none bg-orange-200 text-orange-800 rounded-full font-semibold uppercase tracking-wide text-xs">
                        ...
                        {/* <div className="mt-3 flex justify-around items-center">
                            ...
                            <a
                                href="#"
                                className="flex gap-1 items-center text-sm font-semibold hover:underline text-purple-500"
                            >
                                Deploy <BsArrowRight />
                            </a>
                        </div> */}
